...
public class BlockRedstoneOre extends Block {
    ...
    public void b(World world, int i, int j, int k, Entity entity) {
        ...
        if (entity instanceof EntityHuman) {
            event = CraftEventFactory.callPlayerInteractEvent((EntityHuman) entity, org.bukkit.event.block.Action.PHYSICAL, i, j, k, -1, null);
        } else {
            event = CraftEventFactory.callEntityInteractEvent(entity, world.getWorld().getBlockAt(i, j, k));
        }
